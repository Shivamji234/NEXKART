      ...
      <div className="border-b border-gray-200 pb-6 flex flex-col md:flex-row md:items-end justify-between gap-4">
        ...
        <div className="flex items-center space-x-3">
          <button
            ...
            className="lg:hidden px-4 py-2 bg-white border border-gray-300 rounded text-xs font-semibold uppercase tracking-wider text-luxury-950 flex items-center space-x-2 shadow-sm"
          >
          ...
          {/* Sort Dropdown */}
          <div className="relative flex items-center bg-white border border-gray-300 rounded px-3 py-2 shadow-sm">
            <span className="text-[11px] uppercase tracking-wider text-gray-400 mr-2 font-medium">
              Sort:
            </span>
            <select
              value={sortBy}
              onChange={(e) => setSortBy(e.target.value)}
              className="bg-transparent text-xs font-semibold text-luxury-950 focus:outline-none cursor-pointer tracking-wide"
            >
